...
function root({
  ...
  return {
    ...
    description: truncate(shop?.description ?? 'Los Angeles Premier Dry Eye Products Store - Doctor recommended eye drops, supplements, and treatments for dry eye relief. Free shipping on orders over $100.'),
    handle: '@dryeyela',
    url,
    robots: {
      noIndex: false,
