...
export function DryEyeGuide() {
    return (
        <Section display="flex" className="bg-besilos-sage text-white py-16 md:py-24 relative overflow-hidden">
            ...
            <div className="w-full max-w-4xl mx-auto text-center relative z-10 space-y-8 px-4">
                <div className="space-y-4">
                    ...
                    <Text size="lead" className="max-w-2xl mx-auto text-white/90">
                        Get our comprehensive guide to understanding and managing dry eye syndrome.
                        Learn about the latest treatments, daily habits, and products that actually work.
                    </Text>
                </div>

                <div className="bg-white/10 backdrop-blur-sm p-2 rounded-2xl max-w-lg mx-auto border border-white/20">
                    <Form method="post" action="/newsletter-subscribe" className="flex flex-col sm:flex-row gap-2">
                        <Input
                            type="email"
                            name="email"
                    ...
                    <Text size="fine" className="mt-3 text-white/60">
                        We prefer to keep your email safe. No spam, ever. Unsubscribe anytime.
                    </Text>
                </div>
            </div>
        </Section>
